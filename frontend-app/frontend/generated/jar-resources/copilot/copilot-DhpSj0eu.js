...
const Re = "copilot-", ts = "24.4.19", Dl = "attention-required", Cl = "https://plugins.jetbrains.com/plugin/23758-vaadin", Tl = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Vl = (e, t, r) => t >= e.left && t <= e.right && r >= e.top && r <= e.bottom, rs = (e) => {
  const t = [];
  let r = is(e);
  for (; r; )
...
function Vs() {
  ve.push(import("./copilot-log-plugin-11T1yuQz.js")), ve.push(import("./copilot-info-plugin-CrZqRoNT.js")), ve.push(import("./copilot-features-plugin-kbKTGl_c.js")), ve.push(import("./copilot-feedback-plugin-C8R4KxDk.js")), ve.push(import("./copilot-shortcuts-plugin-t7a7DEgp.js"));
}
function js() {
  {
...
const Ls = Wi(Or);
function Xi() {
  return import("./copilot-notification-Cu5UIEwT.js");
}
const Ms = (e) => {
...
let xn = class extends Ts {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-CLu9W2QA.js"), await import("./copilot-init-step2-C1Grg34I.js"), Vs(), this.tabIndex = 0, Ot.hostConnectedCallback(), window.addEventListener("keydown", wn), x.onSend(this.handleSendEvent), this.removers.push(x.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
